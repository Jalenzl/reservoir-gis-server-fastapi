...
def create_vector_plot_interpolated(url_x, url_y, properties_arr_x, properties_arr_y, properties_arr_composition):

    def create_plot_interpolated():
        # 获取数据
    ...
    return create_plot_interpolated()
